...
.data
    ...
    segundos db 0
     ...
     orBubble db 0ah,0dh, 'Ordenamiento: Bubble Sort' , '$'
     orQuick db 0ah,0dh, 'Ordenamiento: QuickSort' , '$'
     orShell db 0ah,0dh, 'Ordenamiento: ShellSort' , '$'
     ;Generar reporte
